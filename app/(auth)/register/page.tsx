...
export default function RegisterPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-[#154D71] relative overflow-x-hidden p-4 font-sans">
      ...
      <div className="w-full max-w-md p-5 space-y-8 bg-[#1C6EA4] backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 relative z-10 my-auto">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-bold text-[#FFF9AF] tracking-tight">Buat Akun Baru</h1>
          <p className="text-[#FFF9AF]/80 text-base mt-[-10]">Daftar untuk mulai belajar</p>
        </div>

        <div className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-[#FFF9AF] font-medium">Nama Lengkap</Label>
            <AntInput
              id="name"
              type="text"
          ...
          <div className="space-y-2">
            <Label htmlFor="email" className="text-[#FFF9AF] font-medium">Email</Label>
            <AntInput
              id="email"
              type="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="password" className="text-[#FFF9AF] font-medium">Password</Label>
            <AntInput.Password
              id="password"
